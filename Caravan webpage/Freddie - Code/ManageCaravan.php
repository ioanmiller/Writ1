        ...
        <script>
            function confirmDelete() {
                if (confirm("Are you sure you want to delete this vehicle? \n The data will not be able to be retrieved after this.")) {
                    window.location.href = "DeleteVehicle.php?vehicle_id=<?php echo $row['vehicle_id']; ?>";
                }
            }
        </script>
    </head>
    <body>
        ...
        <div class="mngContainerRight">
            ...
            <form action="insert.php">
                ...
                <label for="photoUrl">Links for videos or Pictures:</label>
                <input type="text" id="photoUrl" name="photo_url"><br><br>
